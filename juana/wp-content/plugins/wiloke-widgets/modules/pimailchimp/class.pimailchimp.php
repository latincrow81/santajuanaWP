...
class piMailchimp extends piWilokeWidgets
{
    ...
    public function __construct()
    {
        ...
        parent::__construct('pi_mailchimp', parent::PI_PREFIX . 'Mailchimp', $args);
    ...
    public function form($aInstance)
    {
        ...
        piWilokeWidgets::pi_textarea_field( 'Description', $this->get_field_id('description'), $this->get_field_name('description'), $aInstance['description']);
        ...
        print $atts['before_widget'];
            ...
            <form class="pi_subscribe">
                <div class="form-item form-remove">
                    <input type="email" class="pi-subscribe-email" placeholder="<?php _e('Your mail...', 'wiloke'); ?>" value="" required/>
                </div>
                <div class="form-submit form-remove form-submit">
                    <input type="submit" class="pi-btn pi-subscribe" data-handle="<?php _e('Processing', 'wiloke'); ?>" value="<?php _e('Subscribe', 'wiloke'); ?>">
                </div>
