...
<head>
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/responsive-menu.js" type="text/javascript"></script>
...
<div id="menuResponsive" class="closed">
	...
	<div id="main-slider" class="container">
        ...
        <div id="homepage-message" class="container"><div class="left-section"><h2 style="font-family:'HelveticaLTStdBlk'; font-style:italic; font-size:17px;">Contribuímos con espacios urbanísticos para impactar en el desarrollo y progreso social del país.</h2></div><!-- .left-section --></div>
