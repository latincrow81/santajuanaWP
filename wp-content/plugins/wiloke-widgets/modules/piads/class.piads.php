...
class piAds extends piWilokeWidgets
{
    ...
    {
        $args = array('classname'=>'pi_banner',  'description'=>__('Banner', 'pi'));
        parent::__construct("pi_banner", __( parent::PI_PREFIX . 'Banner', 'pi' ),  $args);
    }
    ...
    */
    public function form( $aInstance )
    {
        ...
        $this->pi_upload_field('Image', $this->get_field_id('image'), $this->get_field_id('upload_button'), $this->get_field_name('image'), false, $aInstance['image']);
