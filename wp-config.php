...
define('DB_NAME', 'db_santajuana');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'tibiTheDBMan');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'vanBaseball897!');

/** Host de MySQL (es muy probable que no necesites cambiarlo) */
define('DB_HOST', 'expohosting.cri2ufjdlfkv.us-west-2.rds.amazonaws.com');
